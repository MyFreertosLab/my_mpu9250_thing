...
scatter3D(mag_model$data_source$MX-mag_model$offsets[1], mag_model$data_source$MY-mag_model$offsets[2], mag_model$data_source$MZ-mag_model$offsets[3], col = "green", add = FALSE)
scatter3D(mag_data_target$MX*250, mag_data_target$MY*250, mag_data_target$MZ*250, col = "red", add = TRUE)
plotrgl()
rglwidget()
